...
function ProjectForm({ handleSubmit, btnText, projectData }) {
    ...
    useEffect(() => { 
        fetch("http://localhost:1818/categories", {
        method: "GET",
        headers: {
    ...
    return (
        <form onSubmit={submit} className={styles.form}>
            ...
            <Input type='number' text="Orçamento do projeto" name="budget" placeholder="Insira o total" handleOnChange={handleChange} value={project.budget ? project.budget : ''}/>
